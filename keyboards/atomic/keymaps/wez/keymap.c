 ...
 * |--------+--------+--------+--------+--------+- 2u ------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | FN/MDIA  | LCTRL     | LGUI     |    ALT   | XXXXXX . SPACE  | RGUI     | RALT     | RCTRL    | FN/MDIA   | LEFT   | DOWN   | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
[BASE] = {
  ...
  {F(FN_MDIA_TOG), KC_LCTL,KC_NO,  KC_LGUI,KC_LALT,KC_SPC, KC_SPC, KC_RGUI,KC_RALT,KC_NO,  KC_RCTL,          F(FN_MDIA_TOG),KC_LEFT, KC_DOWN,KC_RIGHT},
},

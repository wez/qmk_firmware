...
[BASE]=
  KEYMAP(
    // LEFT
    KC_ESC,        ___,      KC_VOLD,      KC_VOLU,  KC_MINS,   KC_EQL,
    KC_GRV,        KC_1,     KC_2,         KC_3,     KC_4,      KC_5,
    KC_TAB,        KC_Q,     KC_W,         KC_E,     KC_R,      KC_T,
    CTL_T(KC_ESC), KC_A,     KC_S,         KC_D,     KC_F,      KC_G,
    KC_LSFT,       KC_Z,     KC_X,         KC_C,     KC_V,      KC_B,
    MO(RAISE),     KC_PGUP,  F(FNCOPYCUT), KC_LCTRL, KC_LALT,   KC_LGUI,
    ___,           KC_PGDN,  M(MPASTE),    KC_LSFT,  MO(RAISE), KC_BSPC,

    // RIGHT
    KC_LBRC,  KC_RBRC,  KC_MUTE,   KC_PSCREEN, ___,     ___,
    KC_6,     KC_7,     KC_8,      KC_9,       KC_0,    ___,
    KC_Y,     KC_U,     KC_I,      KC_O,       KC_P,    KC_BSLS,
    KC_H,     KC_J,     KC_K,      KC_L,       KC_SCLN, KC_QUOT,
    KC_N,     KC_M,     KC_COMM,   KC_DOT,     KC_SLSH, KC_RSFT,
    KC_RGUI,  KC_RALT,  KC_RCTRL,  ___,        KC_UP,   MO(RAISE),
    KC_ENT,   KC_SPC,   KC_RSFT,   KC_LEFT,    KC_DOWN, KC_RIGHT
    ),

  [RAISE]=
  KEYMAP(
    // LEFT
    ___,   ___,     KC_F14, KC_F15, ___,   ___,
    ___,   KC_F1,   KC_F2,  KC_F3,  KC_F4, KC_F5,
    ...
    // RIGHT
    ___,   ___,   ___,     ___,     ___,      ___,
    KC_F6, KC_F7, KC_F8,   KC_F9,   KC_F10,   ___,
    ___,   ___,   ___,     ___,     ___,      ___,
    ___,   ___,   ___,     ___,     ___,      ___,
    ___,   ___,   KC_MPRV, KC_MNXT, KC_MPLY,  ___,
    ___,   ___,   ___,     ___,     KC_PGUP,  ___,
    ___,   ___,   ___,     KC_HOME, KC_PGDN,  KC_END
),

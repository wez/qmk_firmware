...
static const uint8_t row_pins[] = {F7, F6, F5, F4, F1, F0};
static const uint8_t col_pins[] = {C6, D7, B5, B6, B7, D6, C7};
...
static bool read_cols_on_row(matrix_row_t current_matrix[],
  ...
  // Read the columns from the RHS
  bits |= sx1509_read_b(current_row) << 7;
